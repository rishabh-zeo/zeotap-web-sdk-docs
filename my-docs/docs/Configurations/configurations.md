...
The Zeotap Web SDK can be configured by passing an options object during the `init` call. eg: `window.zeotap.init("YOUR_WRITE_KEY", <options>);`

## SDK Configuration Flags

Below is a comprehensive list of available configuration flags:
